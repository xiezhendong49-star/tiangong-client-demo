...
const V3_HISTORY_STORAGE_KEY = 'tiangong-v6-review-effect-history';
...
function generateBase() {
  if (!S.styleImage) { toast('请选择风格参考图'); return; }
  if (!S.floorImage || !S.floorBox) { toast('请选择户型图并框选范围'); return; }
